...
class GroupEntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_entity" do
    assert_difference("GroupEntity.count") do
      post group_entities_url, params: { group_entity: { entity_id: @group_entity.entity_id, group_id: @group_entity.group_id } }
    end
  ...
  test "should update group_entity" do
    patch group_entity_url(@group_entity), params: { group_entity: { entity_id: @group_entity.entity_id, group_id: @group_entity.group_id } }
